//! AES S-box tables.
/// AES S-box used for the [sub_bytes](crate::encrypt::sub_bytes) step in AES encryption.
...
/// AES inverse S-box used for the [inv_sub_bytes](crate::decrypt::inv_sub_bytes) step in AES decryption.
